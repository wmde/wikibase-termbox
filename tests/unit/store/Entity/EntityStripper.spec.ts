...
describe( '/store/Entity/EntityStripper.ts', () => {
	...
	it( 'has labels', () => {
		expect( stripper.getLabels() ).toStrictEqual(
	...
	it( 'returns empty dict if there are no labels', () => {
		expect( emtpyStripper.getLabels() ).toStrictEqual( {} );
	} );

	it( 'has descriptions', () => {
		expect( stripper.getDescriptions() ).toStrictEqual(
			JSON.parse( /* tslint:disable-next-line:max-line-length */
	...
	it( 'returns empty dict if there are no descriptions', () => {
		expect( emtpyStripper.getDescriptions() ).toStrictEqual( {} );
	} );

	it( 'has aliases', () => {
		expect( stripper.getAliases() ).toStrictEqual(
			JSON.parse( /* tslint:disable-next-line:max-line-length */
	...
	it( 'returns empty dict if there are no aliases', () => {
		expect( emtpyStripper.getAliases() ).toStrictEqual( {} );
	} );
} );
